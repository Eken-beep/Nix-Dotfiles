Config { 
   ...
   , template = " <icon=nixos.xpm/> <fc=#3d85c6>|</fc> %XMonadLog% } %date% { %dynnetwork% <fc=#3d85c6>|</fc> %disku% <fc=#3d85c6>|</fc> Kernel: <fc=#3d85c6>%uname%</fc> <fc=#3d85c6>|</fc> %multicpu% <fc=#3d85c6>|</fc> %memory% "
