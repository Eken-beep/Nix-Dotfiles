...
main = xmonad
     . ewmhFullscreen
     . ewmh
     . withSB ( xmobar1 <> xmobar2)
     . docks
     $ myConfig

xmobar1 = statusBarPropTo "_XMONAD_LOG_1" "xmobar /home/edvin/.xmonad/xmobar.hs"  (pure myPP)
xmobar2 = statusBarPropTo "_XMONAD_LOG_2" "xmobar /home/edvin/.xmonad/xmobar2.hs" (pure myPP2)
